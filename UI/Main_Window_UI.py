...
from SkyScanner.assets import source_rc
...
"border-image: url(:/plane_border/plane.png);")
        ...
        self.btnRunCrawler.setStyleSheet("background-color: rgb(172, 172, 172);\n"
        "")
        ...
        self.btnShowData.setStyleSheet("background-color: rgb(172, 172, 172);")
